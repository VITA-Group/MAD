...
class WebCrawler(object):
    ...
    def __init__(self, api_keys, mindate=None, maxdate=None):
    ...
    def fetch_from_flickr(self, keyword, api_key, api_secret, number_links=50):
        ...
        response = flickr.photos_search(api_key=api_key,
                                        text=keyword,
                                        min_upload_date=self.mindate, 
                                        # min_taken_date=mindate,
                                        max_upload_date=self.maxdate, 
        ...
        for photo in images:
            ...
            # upload_dates.append(photo.get('date_upload'))
        ...
        # with open('upload_dates.json', 'w+') as fp:
        #     json.dump(upload_dates, fp)
        # store and reduce the number of images if too much:
        return links
